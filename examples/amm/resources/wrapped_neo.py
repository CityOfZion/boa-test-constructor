...
)  # 10m total supply * 10^0 (decimals)
...
on_approval = CreateNewEvent(
    [("owner", UInt160), ("spender", UInt160), ("amount", int)], "Approval"
)
...
def transfer_from(
    spender: UInt160, from_address: UInt160, to_address: UInt160, amount: int, data: Any
) -> bool:
    """
